    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        ...
        >
          ...
          <div
            className={cn(
              "inline-block group relative bg-gradient-to-b from-black/10 to-black/20",
              "dark:from-white/10 dark:to-white/5 rounded-2xl p-px"
            )}
          >
            <Button
              variant="ghost"
              className="rounded-[1.15rem] px-8 py-6 text-lg font-semibold backdrop-blur-sm
